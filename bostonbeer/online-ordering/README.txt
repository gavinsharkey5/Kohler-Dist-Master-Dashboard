...
Receive, Last Receive Cases, 13-wk Trend %, then Trend Forecast / BBC
Forecast / Diff % for each of the 8 weeks -- always the computed
values, never anything typed into the quick calculator.
